...
\begin{proof}
    ...
    and $\V = \A \tilde{\V}, \V' = \A \tilde{\V}' \in \R^{N_h \times N'}$ arbitrary.
    ...
    \begin{align*}
        ...
        \tilde{\V}' (\tilde{\V}')^T}   \\
        &\leq \vert \Theta' \vert (L  + 2  M ) \left( \euknorm{\mu - \mu'} + \euknorm{t - t'} + \euknorm{\V - \V'}\right),
    \end{align*}
...
This will be inserted in an upcoming part, before the discussion of the DOD-DL-ROM upper complexity bound.
