...
\begin{remark} \label{remark: discrete optimal DOD}
    ...
    may redefine it to $L^\infty$ and set the objective DOD functional for $\Pcal_2$ for the statement and proof
    as
    \begin{equation*}
    ...
    \begin{multline*}
        ...
        \norm{\uht - \V_{\mu, t}
        \V_{\mu, t}^T \G \uht}^2 \\
        \leq \varepsilon  + c_\A' + \sup\limits_{(\mu, t) \in \Theta \times [0, T]} \frac{\euknorm{\Theta'}}{N_{s_2}} 
    ...
    As another note, it is clear, that if $N_A = N_h$, we have $c_\A' = c_\A = 0$ by the definition
...
\begin{proof}
    ...
    (\ref{remark: discrete optimal DOD}) for some fixed $\delta > 0$, fixed $c_\A'$ and its subsequently defined virtual discrete 
    ...
    \begin{align*}
        ...
        &+ \underbrace{m^{-1} \euknorm{\Theta \times [0, T]}^{1/2} c_\A'}_{=: \Ecal_\A} 
        +\underbrace{m^{-1} \euknorm{\Theta \times [0, T]}^{1/2}\delta + m^{-1} \euknorm{\Theta \times [0, T]}^{1/2}
    ...
    \begin{multline*}
        ...
        + \frac{\delta \euknorm{\Theta \times [0, T]}^{1/2}}{m}
...
\begin{proof}  
    ...
    realization
    \begin{equation*}
        \Ecal_\text{R} = \int\limits_{\Theta \times \Theta' \times [0, T]} 
